...
const Navigation = () => {
  ...
  const [open_authModel, setopen_authModel] = useState(false);
  const [open_authcreate,setopen_authcreate] = useState(false);
    ...
    <div className="bg-white">
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-black px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
          Get free delivery on orders over Rupees 1000
        </p>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="#">
                  ...
                  <img alt="" src={x} className="h-8 w-auto" />
                </a>
              </div>
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  {auth.user?.firstName ? (
                    ...
                    <div>
                      <a
                        href="#"
                        className="text-sm font-medium text-gray-700 hover:text-gray-800 m-3"
                        onClick={handleOpen}
                      >
                        Sign in
                      </a>
                ...
                {/* Search */}
                <div className="flex lg:ml-6 border border-black-lg shadow-lg rounded-md hover:text-gray-500">
      ...
      {/* <AuthRegister handleClose={handleClose} open={open_authcreate}/> */}
    </div>
  );
};
